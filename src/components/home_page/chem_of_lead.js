        ...
        >
          <tbody>
            <tr>
              <td>Flammability</td>
              <td>
                Lead does not burn. However, toxic fumes (lead oxides) are
                created in fire.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Reativity</td>
              <td>
                Lead is a reactive metal. It reacts strongly to F2 and Cl2.
              </td>
            </tr>
            <tr>
              <td>Chemical Stability</td>
              <td>
                Lead is a stable element. It has the highest atomic number out
